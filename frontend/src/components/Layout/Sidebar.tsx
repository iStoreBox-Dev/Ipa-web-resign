...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-white dark:bg-zinc-900 border-r border-gray-100 dark:border-zinc-800 h-screen sticky top-0">
      {/* Logo */}
      <div className="px-5 py-6 border-b border-gray-100 dark:border-zinc-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-gray-900 dark:text-white">IPA Resign</h1>
            <p className="text-xs text-gray-400 dark:text-zinc-500">iOS App Signing</p>
          </div>
        </div>
      </div>
